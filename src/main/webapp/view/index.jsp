...
%>
	...
	<h5 class="text-center" style="padding-bottom:20px;">
		...
		<br>
		<a href="<%= addAction %>?query=<%= query%>&status=add" class="btn btn-primary" style="margin-top:20px;" role="button">ADD</a>
	</h5>
...
<script src="https://maxcdn.bootstrapcdn.com/bootstrap/4.3.1/js/bootstrap.min.js"></script>
		...
		<div class="text-center" style="padding-bottom:20px;">
			<a href="<%= addAction %>?query=<%= query%>&status=add" class="btn btn-primary" role="button">ADD</a>
